...
import fs from "fs";
let data = [];
new PdfReader().parseFileItems("./allcolleges.pdf", (err, item) => {
...
const bata = [
  ...
  "127",
  "YMCA ",
  "University of Science & Tech (Formerely ",
  ...
  "Telangana",
  "143",
  "Bharatiya Vidya Bhavan`s Sardar Patel Institute ",
  "of Technology",
  "Mumbai",
  "Maharashtra",
  "144",
  ...
  "Tamil Nadu",
  "165",
  "Goka Raju Ranga Raju Institute of Engineering & ",
  "Technology",
  "Hyderabad",
  "Telangana",
  "166",
  ...
  "Maharashtra",
  "43",
  "Narayana Medical College, Sri Potti Sriramulu Nellore",
  "Andhra Pradesh",
  "43",
  ...
  "Chennai",
  "54",
  "Byramjee Jeejeebhoy Government Medical College and ",
  "Sassoon General Hospital, and College of Nursing, Pune",
  "and College of ",
  "Nursing",
  "55",
  ...
  "Pondicherry",
  "72",
  "Nil RatanSircar Medical College and Hospital, Kolkata",
  "Kolkata",
  "73",
  "RUHS College of ",
  ...
  "Jhansi",
  "81",
  "S Nijalingappa Medical College and HSK ",
  "Hospital and ",
  "Research Centre, Navanagar",
  "Navanagar",
  "82",
  ...
  "Indore",
  "93",
  "LalaLajpatRai Memorial Medical College, ",
  "Meerut",
  "Meerut",
  "94",
  ...
  "Patiala",
  "95",
  "NetajiSubhash Chandra Bose Medical College and ",
  "Hospital, Jabalpur",
  "Jabalpur",
  "96",
  ...
  "101",
  "Tomo Riba Institute ",
  "Health and Medical Sciences, Naharlagun",
  "102",
  "Assam Medical College, Dibrugarh",
  "103",
  "SMC Silchar ",
  ...
  "Delhi",
  "80",
  "Sri Balaji Vidyapeeth Mahatma Gandhi ",
...
console.log(typeof bata)
  ...
  for (let i = 0; i < bata.length; i ++) {
    ...
    const collegeName = bata[i];
    
if(collegeName.length>12)
    jsonArray.push({  collegeName});
  }

  const jsonContent = JSON.stringify(jsonArray);

  fs.writeFile("./collegeoutput.json", jsonContent, "utf8", (err) => {
    if (err) {
      console.error("Error writing the JSON file:", err);
      return;
    }
    console.log("TXT to JSON conversion complete.");
    console.log("Output JSON file: output.json");
  });
