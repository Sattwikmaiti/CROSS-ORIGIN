...
export declare class OpenAI extends BaseLLM implements OpenAIInput {
    ...
    /** @ignore */
    completionWithRetry(request: CreateCompletionRequest, options?: StreamingAxiosConfiguration): Promise<import("axios").AxiosResponse<CreateCompletionResponse, any>>;
    _llmType(): string;
}
/**
